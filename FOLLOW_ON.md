...
- A Mac-side threshold screen under `experiment_runtime/runs/follow_on/calibration/` showed that higher thresholds reduce false positives but reintroduce some `50x` adaptive leakage.
